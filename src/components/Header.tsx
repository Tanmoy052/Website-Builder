    ...
    <header className="flex-shrink-0 bg-gray-800/50 border-b border-gray-700 px-4 py-2 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          >
            {/* FIX: Updated model name and value to reflect current Gemini API guidelines. */}
            <option value="gemini-3-pro-preview">Gemini 3 Pro</option>
            <option value="gpt-4" disabled>GPT-4 (Soon)</option>
            <option value="deepseek-coder" disabled>DeepSeek (Soon)</option>
          </select>
